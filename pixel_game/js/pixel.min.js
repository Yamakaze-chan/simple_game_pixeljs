// Pixel.js :: Copyright (C) 2013 rastating
//
// Version 0.3b
//
...
PixelJS.Entity.prototype.collidesWith = function(entity) {
    "use strict";
    return this.pos.x + this.size.width > entity.pos.x && this.pos.x < entity.pos.x + entity.size.width && this.pos.y + this.size.height > entity.pos.y && this.pos.y < entity.pos.y + entity.size.height;
}
;
...
PixelJS.FPSCounter.prototype.draw = function() {
    this.layer.drawText('FPS: ' + Math.round(this.fps, 2), this.pos.x, this.pos.y, '18px "Courier New", Courier, monospace', '#00FF00');
}
;
...
PixelJS.SpriteSheet.prototype._getFrameData = function(row, frame, transparencyKey) {
    ...
    var ctx = canvas.getContext('2d');
    ctx.drawImage(this.image, 0 + Math.ceil(this._frameSize.width * frame), 0 + Math.ceil(this._frameSize.height * row), this._frameSize.width, this._frameSize.height, 0, 0, this._frameSize.width, this._frameSize.height);
